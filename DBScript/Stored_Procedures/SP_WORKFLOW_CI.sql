...
BEGIN       
    ...
    IF Type = 'SearchInitialize' THEN
        ...
        INNER JOIN `function` f ON f.Function_Id = ad.Document_Id AND a.Document_Id <> 41 and a.Document_Id <> 42
        ...
        WHERE a.Plant_Id = PlantId AND 
        (ad.Primary_User_Id = UserId OR ad.Secondary_User_Id = UserId) 
