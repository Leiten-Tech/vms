...
set SQL_DIR=E:\TFS\VisitorManagement\Demo-branch\MYSQL\MySQL-DBScript\Tables\Create

REM Loop through each SQL file in the directory and run it on the remote MySQL server
