              ...
              <div className="col-12 md:col-9">
                <div className="grid">
                  <FormFields
                    ...
                    show={true}
                    required={false}
                    disable={DisableSupplier || isView ? true : false}
...
const CVehicleCreator = (props) => {
  const { setVehicleShow, fetchAllData } = props;
  ...
  const vehicleForm = {
    ...
    VehicleFcDate: HdrTable != null ? new Date(HdrTable.VehicleFcDate) : "",
    ServiceDate: HdrTable != null ? new Date(HdrTable.ServiceDate) : "",
...
export default CVehicleCreator;
